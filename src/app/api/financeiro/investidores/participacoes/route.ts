...
/**
 * Participação dos investidores nos veículos — o lado de quem LANÇA.
 *
 * Esta rota morava em `/api/financeiro/investidores` e mudou de endereço em
 * 2026-08-22, quando dois trabalhos paralelos entregaram módulos de investidor
 * no mesmo caminho: um cadastro com razão de aportes e retiradas, e esta
 * participação por veículo. Os dois respondem perguntas diferentes — *quanto*
 * o sócio tem no negócio e *em quais carros* ele entrou — então os dois
 * ficaram, e é o endereço que os separa. O cadastro seguiu com
 * `/api/financeiro/investidores`, que já era dono das sub-rotas `[id]` e
 * `movimentacoes`; a participação veio para cá.
 *
