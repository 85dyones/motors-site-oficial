---
url: /guias/cambio-dupla-embreagem-usado
pilar: 3 — Mecânica de risco do seminovo moderno
papel: SPOKE
onda: 2
keyword_primaria: câmbio dupla embreagem problema
keyword_secundarias: câmbio de dupla embreagem em carro usado · DCT a seco problema · trepidação na saída dupla embreagem · comprar carro com dupla embreagem
saida_comercial: /garantia
palavras: ~1.600
---

# Câmbio de dupla embreagem em carro usado: o que checar

**Title:** `Câmbio de dupla embreagem usado: o que checar | Motors Store`
**Meta description:** `Trepidação na saída, atraso de engate e solavanco entre marchas não são jeito do câmbio: são sintoma. O que testar no test-drive, frio e quente.`
...
[Como funciona a garantia de motor e câmbio →](/garantia)
...
**Entradas:** pilar da Onda 2 · `/guias/vicio-oculto-carro-usado` · hub `/guias` · ficha de veículo com câmbio de dupla embreagem (R8) · `/garantia`

**Para `TERMOS_COM_DESTINO` quando a onda subir:** `Câmbio de dupla embreagem em carro usado: o que checar` → `/guias/cambio-dupla-embreagem-usado`, e o termo temático `dupla embreagem` → mesmo destino.
...
`about`: Câmbio de dupla embreagem · Transmissão automatizada · Compra de carro usado.
...
- [x] T3 — nada que contradiga a `/garantia`. A peça não promete laudo na ficha; diz que o laudo fica com o vendedor e sai a pedido
- [x] T4 — descritivo. Nenhum concorrente nomeado, nenhuma ironia com o leitor
- [x] T5 — sem conteúdo jurídico
- [x] T6 — nenhum número publicado além dos fatos da casa (3 em 10, 3 meses, 7.000 km / 6 meses do plano). Nenhum preço, nenhuma estatística de falha
- [x] Critério 3 — uma saída comercial, no fim, uma vez
- [x] H1 contém a query, 54 caracteres
