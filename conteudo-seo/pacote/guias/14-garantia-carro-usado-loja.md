---
url: /guias/garantia-carro-usado-loja
pilar: 2 — Garantia e o que acontece depois da compra
papel: PILAR
onda: 2
keyword_primaria: garantia de carro usado em loja
keyword_secundarias: loja é obrigada a dar garantia em carro usado · garantia de 3 meses carro usado · o que a garantia de loja cobre · garantia de motor e câmbio
saida_comercial: /garantia
palavras: ~1.900
---

# Garantia de carro usado em loja: o que está coberto

**Title:** `Garantia de carro usado em loja: o que cobre`
**Meta description:** `O que a garantia de uma loja cobre, o que fica de fora e a regra que decide tudo: avisar antes de levar o carro a qualquer oficina.`
...
**A garantia cobre embreagem, pneu ou bateria?**
Não. Esses são itens de desgaste: existem para gastar e, num carro usado, chegam com parte da vida já usada. É por isso que o estado deles entra na negociação do preço, e não na conversa de garantia. Em carro de dupla embreagem, vale checar o conjunto antes de comprar, porque o reparo é caro e a exclusão é a mesma em qualquer loja.
...
| Trecho | Destino |
|---|---|
| "Garantia estendida de carro usado vale a pena?" | `/guias/garantia-estendida-vale-a-pena` **(peça irmã, mesma onda)** |
| "Correia dentada banhada em óleo: por que ela falha" | `/guias/correia-dentada-banhada-em-oleo` |
| "Câmbio de dupla embreagem em carro usado: o que checar" | `/guias/cambio-dupla-embreagem-usado` |
| "Laudo cautelar: o que verifica e o que não verifica" | `/guias/laudo-cautelar-carro-usado` **(pilar da Onda 1)** |
| "Vício oculto em carro usado: o que é e o que não é" | `/guias/vicio-oculto-carro-usado` |
| CTA final | `/garantia` |

**Entradas:** hub `/guias` · `/garantia` · as quatro peças de mecânica desta onda
...
`about`: Garantia de veículo usado · Compra em concessionária ou loja · Direitos do consumidor.
...
- [x] T1 e T2 — nenhum multiplicador de deságio, nenhuma menção a FIPE ou desconto
- [x] T3 — nada que contradiga a página `/garantia`: prazo, escopo, exclusões, oficina indicada e a regra de avisar antes são os mesmos
- [x] T4 — descritivo. Nenhum concorrente nomeado; a comparação de mercado é sobre prática ("peça coberta, mão de obra não"), não sobre empresa
- [x] T5 — sem parecer jurídico: a peça diz que a garantia legal existe, não descreve o alcance dela e manda a dúvida ao Procon ou a um advogado
- [x] T6 — os únicos números são fatos da casa: três meses, mais de quinze oficinas, três em dez. Nenhum preço, nenhum percentual, nenhuma quilometragem
- [x] Regra 1 dos fatos — o laudo fica com o vendedor e sai a pedido
