---
url: /guias/carbonizacao-valvulas-injecao-direta
pilar: 3 — Mecânica de risco do seminovo moderno
papel: SPOKE — par técnico do pilar
onda: 2
...
**Title:** `Carbonização de válvulas na injeção direta: o que fazer`
**Meta description:** `Na injeção direta o combustível não lava a válvula de admissão, e o vapor de óleo assa ali. Quando aparece, como checar antes de comprar e o que resolve.`
...
**Carbonização de válvulas tem cura?**
A limpeza resolve o acúmulo, e o jateamento com casca de noz é o método padrão quando o carvão já está endurecido. O que não se resolve com limpeza é a causa: se a ventilação do cárter estiver comprometida, se houver consumo de óleo ou se o uso continuar sendo de trajeto curto com muita marcha lenta, o depósito volta.

**Andar de etanol ou de gasolina muda alguma coisa?**
Na válvula de admissão, não. Em injeção direta pura o combustível vai direto para o cilindro e não toca essa válvula, qualquer que seja ele. O que muda o ritmo do depósito é o óleo, a ventilação do cárter e o tipo de uso.

**Motor de injeção direta usado é má compra?**
Não. É uma compra com um custo conhecido, que precisa entrar na conta antes da assinatura em vez de aparecer depois. Um scanner com leitura ao vivo e o histórico de uso e de óleo dizem, em poucos minutos, se esse custo está perto ou longe.

**Como diferenciar carbonização de vela ou bobina com defeito?**
Pelos sintomas, não dá: falha a frio, marcha lenta irregular e luz de injeção aparecem nos três casos. Diferencia-se por exclusão e inspeção — vela e bobina são baratas de testar e trocar, e são o primeiro passo de qualquer oficina; se a falha persistir, a inspeção do duto de admissão é o passo seguinte.
...
| "Correia dentada banhada em óleo: por que ela falha" | `/guias/correia-dentada-banhada-em-oleo` |
| CTA final | `/garantia` |

**Entradas:** pilar da onda · a peça irmã · hub `/guias` · ficha de veículo com injeção direta (R8)
...
```json
{
  ...
  "@type": "Article",
  "@id": "https://motorsstore.com.br/guias/carbonizacao-valvulas-injecao-direta#article",
  "headline": "Carbonização de válvulas em injeção direta",
  "description": "Por que a injeção direta carboniza a válvula de admissão, quando isso aparece, como checar antes de comprar e o que resolve o depósito.",
  "inLanguage": "pt-BR",
  ...
  "mainEntityOfPage": "https://motorsstore.com.br/guias/carbonizacao-valvulas-injecao-direta",
  "about": [
    { "@type": "Thing", "name": "Injeção direta" },
    { "@type": "Thing", "name": "Carbonização de válvulas de admissão" },
...
- **Custo em reais.** A peça publica ordem de grandeza declarada como estimativa de mercado, e nenhum valor. Se o dono quiser faixa em reais para Curitiba, ela precisa de levantamento próprio com data e método declarados no texto — é a regra 2 dos fatos e a T6 do guia normativo.
- **Nomear motores de injeção dupla** ajudaria o leitor a se localizar. Mesma decisão editorial da peça 09: descrever a tecnologia, não a marca. Reversível com aval do dono.
...
- [x] T4 — descritivo. Nenhum fabricante acusado; a injeção direta é tratada como tecnologia com efeito colateral conhecido
- [x] T5 — sem parecer jurídico
- [x] T6 — os únicos números são fatos da casa: três meses de garantia e 7.000 km ou 6 meses do plano. O custo entra só como ordem de grandeza, declarada no texto como estimativa de mercado e não como preço da loja nem da região
