---
url: /guias/vicio-oculto-carro-usado
pilar: 3 — Mecânica de risco do seminovo moderno (ponte para o Pilar 2)
papel: SPOKE — peça-ponte para `/garantia`
onda: 2
keyword_primaria: vício oculto carro usado
keyword_secundarias: o que é vício oculto · vício oculto ou desgaste natural · defeito depois de comprar carro usado · laudo cautelar garante motor
saida_comercial: /garantia
palavras: ~1.600
---

# Vício oculto em carro usado: o que é e o que não é

**Title:** `Vício oculto em carro usado: o que é | Motors Store`
**Meta description:** `Vício oculto é o defeito que já existia na venda e não dava para perceber. O que a perícia alcança, o que ela não alcança e o que a garantia banca.`
...
[O que a garantia de motor e câmbio cobre →](/garantia)

---

## FAQ

**O que é vício oculto em carro usado?**
É o defeito que já existia quando o carro foi vendido, não era perceptível num exame comum na hora da compra e aparece depois, comprometendo o uso ou o valor do veículo. Peça que se desgastou com o uso, defeito que estava à vista na compra e dano ocorrido depois são outras três coisas. A diferença entre elas é o que decide quase toda discussão.

**Laudo cautelar garante que o carro não tem vício oculto?**
Não. O laudo cautelar examina identificação, estrutura e histórico — é exame de procedência. Ele não abre motor, não mede compressão e não avalia bomba de alta pressão, então não tem como responder pela saúde mecânica do veículo. Um carro pode passar na cautelar e apresentar falha mecânica depois.

**Comprei um carro usado e apareceu um defeito. Qual é o primeiro passo?**
...
| "Laudo cautelar: aprovado, com apontamento ou reprovado" | `/guias/resultados-laudo-cautelar` |
| "Câmbio de dupla embreagem em carro usado: o que checar" | `/guias/cambio-dupla-embreagem-usado` *(Onda 2 — link quando as duas subirem juntas)* |
| "perícia cautelar" (1ª ocorrência) | `/garantia` *(termo automático de `linksNoTexto.ts`)* |
| CTA final | **`/garantia`** |

**Entradas:** `/garantia` (a matriz 2.2 do guia normativo já prevê "guia de vício oculto" como saída da página) · pilar da Onda 2 · `/guias/cambio-dupla-embreagem-usado` · `/guias/carro-reprovado-cautelar-como-vender`, que cita vício oculto duas vezes · hub `/guias`

**Para `TERMOS_COM_DESTINO` quando a onda subir:** `Vício oculto em carro usado: o que é e o que não é` → `/guias/vicio-oculto-carro-usado`, e o termo temático `vício oculto` → mesmo destino. O termo temático é o de maior efeito da onda: "vício oculto" já aparece no corpo e no FAQ da peça 07 da Onda 1 sem destino nenhum.
...
`about`: Vício oculto · Compra de carro usado · Garantia de veículo usado.
...
- [x] T1 — nenhum multiplicador nem percentual de deságio
- [x] T2 — nenhuma ocorrência de "abaixo da FIPE" ou "desconto"
- [ ] **T3 — pendente**, ver o item do diferencial acima
- [x] T4 — descritivo. O mercado é descrito, não denunciado; nenhum concorrente nomeado
- [x] T5 — encaminha a Procon ou advogado, declara que não é parecer jurídico, não cita artigo nem prazo
- [x] T6 — nenhum número publicado além dos fatos da casa (3 em 10, 3 meses, mais de 15 oficinas, 120 pontos da cautelar)
- [x] T8 — não enumera direitos previstos em lei nem explica artigo; e não sugere que a garantia contratual seja a única cobertura existente
- [x] Critério 3 — uma saída comercial, no fim, uma vez
- [x] H1 contém a query, 50 caracteres
- [x] Primeiro parágrafo responde em duas frases
- [x] Corpo em texto puro: sem tabela, sem lista com hífen, sem negrito, sem link escrito
- [x] Vocabulário proibido ausente (premium, luxo, exclusivo, consulte-nos, melhores preços, procedência garantida)
