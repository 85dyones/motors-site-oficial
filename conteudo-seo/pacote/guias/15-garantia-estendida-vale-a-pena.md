---
url: /guias/garantia-estendida-vale-a-pena
pilar: 2 — Garantia e o que acontece depois da compra
papel: SPOKE — decisão de compra, alta intenção
onda: 2
keyword_primaria: garantia estendida de carro usado vale a pena
keyword_secundarias: garantia estendida carro usado · o que a garantia estendida cobre · garantia estendida cobre turbo · plano de motor e câmbio
...
**Title:** `Garantia estendida de carro usado vale a pena?`
**Meta description:** `O que o plano cobre, o que ele não cobre e as duas obrigações que reprovam acionamento. Leia antes de assinar — inclusive o que fica de fora.`
...
[O que a garantia da loja cobre →](/garantia)
...
Nenhum link escrito no corpo: quem cria link é `TERMOS_COM_DESTINO` (`src/lib/linksNoTexto.ts`). As citações estão pelo título.

| Trecho | Destino |
|---|---|
| "Garantia de carro usado em loja: o que está coberto" | `/guias/garantia-carro-usado-loja` **(pilar do Pilar 2)** |
| "Motor turbo de baixa cilindrada usado: o que checar" | `/guias/motores-turbo-usados-o-que-checar` |
| "Câmbio de dupla embreagem em carro usado: o que checar" | `/guias/cambio-dupla-embreagem-usado` |
| CTA final | `/garantia` |

**Entradas:** o pilar do Pilar 2 · as peças de mecânica desta onda · hub `/guias` · `/garantia`
...
`about`: Garantia estendida · Plano de motor e câmbio · Compra de carro usado.
...
- [x] T3 — nada que contradiga a página `/garantia`, que descreve o mesmo plano com as mesmas condições
- [x] T4 — descritivo. A administradora é nomeada uma vez, sem juízo de valor; nenhum concorrente é citado
- [x] T5 — sem parecer jurídico: a peça diz que o plano é acréscimo à garantia legal e não descreve o alcance dela
- [x] T6 — os únicos números são do manual e dos fatos da casa: 7.000 km ou 6 meses, 180 mil km, oito anos, três dias úteis, 72 horas, três meses da loja. Nenhum preço, nenhum percentual, nenhum teto inventado
- [x] Venda casada — a peça diz duas vezes que contratar é opcional e que não muda preço, financiamento nem entrega
- [x] Não chama o plano de seguro, e explica por quê
