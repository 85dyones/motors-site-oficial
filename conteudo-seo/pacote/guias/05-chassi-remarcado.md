---
url: /guias/chassi-remarcado
pilar: 1 — Procedência e perícia cautelar
papel: SPOKE — deep dive técnico-jurídico
onda: 1
keyword_primaria: chassi remarcado
keyword_secundarias: chassi remarcado é crime · regravação de chassi · chassi adulterado o que fazer · chassi remarcado desvaloriza
saida_comercial: /estoque
palavras: ~2.000
---

# Chassi remarcado: quando é legal e quando é crime

**Title:** `Chassi remarcado: quando é legal e quando é crime`
**Meta description:** `Existe remarcação de chassi autorizada e registrada no documento. E existe adulteração, que é crime. Como diferenciar antes de comprar um carro usado.`
...
Um carro não tem um número. Tem vários, espalhados de propósito.

- **Gravação no monobloco ou chassi** — a numeração principal, estampada na estrutura
- **Etiquetas de identificação** — distribuídas por painéis da carroceria, com destruição programada se removidas
- **Gravação nos vidros**
- **Numeração de motor e de câmbio**
- **Plaqueta de identificação** e placas
...
Um chassi pode precisar ser regravado por razões inteiramente legítimas:

- **Corrosão** que tornou a numeração ilegível
- **Reparo estrutural** que exigiu substituição da parte onde a gravação estava
- **Desgaste** ou dano acidental na área da estampagem
- **Recuperação de veículo furtado ou roubado** em que a numeração foi violada pelo criminoso
...
Compare com a passagem por leilão, que [não consta em documento nenhum](/guias/consultar-carro-leilao-sinistro). São situações opostas: uma é anotada por definição, a outra nunca é.
...
| | Remarcação regular | Adulteração |
|---|---|---|
| **Autorização** | Prévia, do Detran | Nenhuma |
| **Quem executa** | Empresa credenciada | Qualquer um |
| **Laudo técnico** | Exigido | Inexistente |
| **Documento** | Traz a observação de remarcado | Nada consta — é esse o objetivo |
| **Consistência** | Numeração bate em todos os pontos | Diverge entre pontos, ou com o registro |
| **Acabamento** | Padrão técnico definido | Irregular, profundidade e alinhamento inconsistentes |
| **Consequência** | Carro regular, com desvalorização | Crime, com o veículo sujeito a apreensão |
...
**No nosso estoque essa conferência já foi feita, e o resultado dela está publicado na ficha do carro, eixo de identificação incluído.**
...
Não dá para saber com segurança a olho nu. A conferência exige comparação entre vários pontos de identificação e cruzamento com o registro, que é o que a [perícia cautelar](/guias/laudo-cautelar-carro-usado) faz de forma sistemática.
...
| Trecho | Destino |
|---|---|
| "não consta em documento nenhum" | `/guias/consultar-carro-leilao-sinistro` |
| "perícia cautelar" (FAQ e corpo) | `/guias/laudo-cautelar-carro-usado` **(pilar)** |
| "É reprovação" (o que fazer) | `/guias/resultados-laudo-cautelar` |
| "três entram" | `/guias/o-que-reprova-pericia-cautelar` |
| "exija perícia cautelar" (fechamento) | `/guias/pericia-cautelar-curitiba` |
| CTA final | `/estoque` |

**Entradas:** pilar · `/guias/resultados-laudo-cautelar` · `/guias/consultar-carro-leilao-sinistro` · hub

---

## Schema

`Article` + `BreadcrumbList` + `FAQPage`. `about`: Chassi · Adulteração de sinal identificador · Perícia cautelar.
...
- [x] T1 e T2 — sem multiplicadores, sem menção a FIPE
- [x] T3 — coerente com o pilar e com o guia de leilão
- [x] T4 — descritivo. Nenhum concorrente nomeado. A crítica é à conduta, não a pessoas ou empresas
- [x] T5 — cita a lei e encaminha a advogado, Procon e delegacia. Declara explicitamente que não é parecer
- [x] T6 — o único número próprio é o 3 em 10. Pena e resolução são citadas com a fonte normativa
- [x] Critério 3 — uma saída comercial
- [x] H1 contém a query, 48 caracteres
